...
namespace Uni.WebApi.Controllers
{
    ...
    public class SmjerController : ApiController
    {
        ...
        public SmjerController(IStudentController service)
        {
            this.Service = service;
        }

        protected IStudentController Service { get; private set; }
        ...
        public async Task<HttpResponseMessage> GetAllAsync(string sortby= "", string sortmethod = "",int itemsperpage=0,int pagenumber = 0,string search ="")
        {
            ...
            List<Smjer> smjerovi = await Service.GetAllAsync(sort,pager,filter);
